...
/**
 * A DTO for the ProjectValidator entity.
 */
public class ProjectValidatorDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        ProjectValidatorDTO projectValidatorDTO = (ProjectValidatorDTO) o;
        if (projectValidatorDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), projectValidatorDTO.getId());
    }
